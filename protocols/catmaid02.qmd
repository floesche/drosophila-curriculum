...
With a stable internet connection open [CATMAID](http://tinyurl.com/larval-cns) to access the L1 brain. For how-to movies see the [first part of this module](catmaid.qmd).
